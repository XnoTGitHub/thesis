...
create_output_images('autoencoder_output_final', autoencoder, valid_dataloader, device)
# Dataset Same
autoencoder.load_state_dict(torch.load('ResNet18_Same_Dataset.pt'))
create_output_images('autoencoder_output_same', autoencoder, valid_dataloader, device)
# Dataset Same
autoencoder.load_state_dict(torch.load('ResNet18_Other_Dataset.pt'))
create_output_images('autoencoder_output_other', autoencoder, valid_dataloader, device)
